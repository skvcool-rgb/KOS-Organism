"""
Auto-generated learned engine: learned_f76d97a5_1775396594
Task: f76d97a5
Description: Evolved for f76d97a5: SEQ(SWAP(COLOR_MAX,COLOR_MIN) -> SWAP(5,0))
AST: ('SEQ', ('SWAP', 'COLOR_MAX', 'COLOR_MIN'), ('SWAP', 5, 0))
