"""
Auto-generated learned engine: learned_44f52bb0_1775375309
Task: 44f52bb0
Description: Evolved for 44f52bb0: SEQ(SEQ(OVERLAY(SWAP(COLOR_BG,COLOR_SECOND), RECOLOR(COLOR_BG,1)) -> OVERLAY(SWAP(2,0), SHIFT_RIGHT) -> RECOLOR(2,COLOR_BG)) -> EXTRACT_QUADRANT_TL -> RECOLOR(2,7) -> FILL_BG(7))
AST: ('SEQ', ('SEQ', ('OVERLAY', ('SWAP', 'COLOR_BG', 'COLOR_SECOND'), ('RECOLOR', 'COLOR_BG', 1)), ('OVERLAY', ('SWAP', 2, 0), 'SHIFT_RIGHT'), ('RECOLOR', 2, 'COLOR_BG')), 'EXTRACT_QUADRANT_TL', ('RECOLOR', 2, 7), ('FILL_BG', 7))
...
def apply_rule(grid, rule=None):
    ...
    result_a = state.copy()
    state = state_a.copy()
    state[state == _resolve_color("COLOR_BG", _orig_grid)] = 1
    result_b = state.copy()
    state = result_a.copy()
    mask = result_b != 0
