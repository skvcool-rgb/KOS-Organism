"""
Auto-generated learned engine: learned_9ecd008a_1775440944
Task: 9ecd008a
Description: Evolved for 9ecd008a: SEQ(('MASK_DIFF', ('MASK_XOR', ('RECOLOR', 'COLOR_BG', 'ORIG_COLOR_BG'), ('OVERLAY', ('SWAP', 'COLOR_BG', 'COLOR_SECOND'), 'FLIP_H')), ('IF_COLOR', 'ORIG_COLOR_BG', ('RECOLOR', 'ORIG_COLOR_MIN', 'COLOR_FG_2'), ('SWAP', 'COLOR_MIN', 'COLOR_SECOND'))) -> DELETE_COLS_ZERO -> DELETE_ROWS_ZERO)
AST: ('SEQ', ('MASK_DIFF', ('MASK_XOR', ('RECOLOR', 'COLOR_BG', 'ORIG_COLOR_BG'), ('OVERLAY', ('SWAP', 'COLOR_BG', 'COLOR_SECOND'), 'FLIP_H')), ('IF_COLOR', 'ORIG_COLOR_BG', ('RECOLOR', 'ORIG_COLOR_MIN', 'COLOR_FG_2'), ('SWAP', 'COLOR_MIN', 'COLOR_SECOND'))), 'DELETE_COLS_ZERO', 'DELETE_ROWS_ZERO')
...
def apply_rule(grid, rule=None):
    ...
    state = grid.copy()
    pass  # Unknown AST node: ('MASK_DIFF', ('MASK_XOR', ('RECOLOR', 'COLOR_BG', 'ORIG_COLOR_BG'), ('OVERLAY', ('SWAP', 'COLOR_BG', 'COLOR_SECOND'), 'FLIP_H')), ('IF_COLOR', 'ORIG_COLOR_BG', ('RECOLOR', 'ORIG_COLOR_MIN', 'COLOR_FG_2'), ('SWAP', 'COLOR_MIN', 'COLOR_SECOND')))
