"""
Auto-generated learned engine: learned_3af2c5a8_1775481536
Task: 3af2c5a8
Description: PHASE2-TYPED: MIRROR_V(MIRROR_H(INPUT))
AST: ('MIRROR_V', ('MIRROR_H', 'INPUT'))
...
def apply_rule(grid, rule=None):
    ...
    state = grid.copy()
    pass  # state is already the input grid
    state = np.concatenate([state, np.fliplr(state)], axis=1)
    state = np.concatenate([state, np.flipud(state)], axis=0)
