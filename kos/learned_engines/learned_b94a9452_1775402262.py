"""
Auto-generated learned engine: learned_b94a9452_1775402262
Task: b94a9452
Description: Evolved for b94a9452: SEQ(FILL_BG(ORIG_COLOR_BG) -> SEQ(('CROP_TO_COLOR', 'COLOR_FG_1') -> SEQ(ROT180 -> DELETE_ROWS_ZERO) -> SWAP(COLOR_FG_2,COLOR_BG)))
AST: ('SEQ', ('FILL_BG', 'ORIG_COLOR_BG'), ('SEQ', ('CROP_TO_COLOR', 'COLOR_FG_1'), ('SEQ', 'ROT180', 'DELETE_ROWS_ZERO'), ('SWAP', 'COLOR_FG_2', 'COLOR_BG')))
...
def apply_rule(grid, rule=None):
    ...
    state = grid.copy()
    state[state == 0] = _resolve_color("COLOR_BG", _orig_grid)
    _cv = _resolve_color("COLOR_FG_1", _orig_grid)
    ...
    _c1, _c2 = _resolve_color("COLOR_FG_2", _orig_grid), _resolve_color("COLOR_BG", _orig_grid)
