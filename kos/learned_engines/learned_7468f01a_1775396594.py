"""
Auto-generated learned engine: learned_7468f01a_1775396594
Task: 7468f01a
Description: Evolved for 7468f01a: SEQ(CROP_NONZERO -> OVERLAY(IF_COLOR(8, SEQ(DELETE_ROWS_ZERO -> SWAP(COLOR_MIN,COLOR_MAX) -> DELETE_COLS_ZERO), SEQ(RECOLOR(2,5) -> ROT180 -> SHIFT_UP)), FLIP_H))
AST: ('SEQ', 'CROP_NONZERO', ('OVERLAY', ('IF_COLOR', 8, ('SEQ', 'DELETE_ROWS_ZERO', ('SWAP', 'COLOR_MIN', 'COLOR_MAX'), 'DELETE_COLS_ZERO'), ('SEQ', ('RECOLOR', 2, 5), 'ROT180', 'SHIFT_UP')), 'FLIP_H'))
