"""
Auto-generated learned engine: learned_63613498_1775375309
Task: 63613498
Description: Evolved for 63613498: SEQ(IF_COLOR(4, RECOLOR(1,5), IF_COLOR(COLOR_MIN, SWAP(6,9), IF_COLOR(1, RECOLOR(6,COLOR_BG), GRAVITY_LEFT))) -> RECOLOR(9,5))
AST: ('SEQ', ('IF_COLOR', 4, ('RECOLOR', 1, 5), ('IF_COLOR', 'COLOR_MIN', ('SWAP', 6, 9), ('IF_COLOR', 1, ('RECOLOR', 6, 'COLOR_BG'), 'GRAVITY_LEFT'))), ('RECOLOR', 9, 5))
...
def apply_rule(grid, rule=None):
    ...
    if 4 in state:
        ...
        if _resolve_color("COLOR_MIN", _orig_grid) in state:
            ...
            if 1 in state:
                state[state == 6] = _resolve_color("COLOR_BG", _orig_grid)
            else:
                state = _gravity(state, 'left')
    state[state == 9] = 5
