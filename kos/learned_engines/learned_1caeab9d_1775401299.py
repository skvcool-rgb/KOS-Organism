"""
Auto-generated learned engine: learned_1caeab9d_1775401299
Task: 1caeab9d
Description: Evolved for 1caeab9d: ('IF_PROPERTY', 'RIGHTMOST', ('SEQ', ('ALIGN_V', 'TOPMOST'), ('ALIGN_V', 'BOTTOMMOST'), ('IF_PROPERTY', 'IS_SOLID', 'GRAVITY_DOWN', ('FOR_EACH_NODE', ('ALIGN_V', 'MOST_FREQUENT_COLOR'))), ('ALIGN_V', 'TOPMOST')), ('ALIGN_V', 'SMALLEST_AREA'))
AST: ('IF_PROPERTY', 'RIGHTMOST', ('SEQ', ('ALIGN_V', 'TOPMOST'), ('ALIGN_V', 'BOTTOMMOST'), ('IF_PROPERTY', 'IS_SOLID', 'GRAVITY_DOWN', ('FOR_EACH_NODE', ('ALIGN_V', 'MOST_FREQUENT_COLOR'))), ('ALIGN_V', 'TOPMOST')), ('ALIGN_V', 'SMALLEST_AREA'))
...
def apply_rule(grid, rule=None):
    ...
    state = grid.copy()
    pass  # Unknown AST node: ('IF_PROPERTY', 'RIGHTMOST', ('SEQ', ('ALIGN_V', 'TOPMOST'), ('ALIGN_V', 'BOTTOMMOST'), ('IF_PROPERTY', 'IS_SOLID', 'GRAVITY_DOWN', ('FOR_EACH_NODE', ('ALIGN_V', 'MOST_FREQUENT_COLOR'))), ('ALIGN_V', 'TOPMOST')), ('ALIGN_V', 'SMALLEST_AREA'))
