"""
Auto-generated learned engine: learned_f25fbde4_1775396594
Task: f25fbde4
Description: Evolved for f25fbde4: SEQ(SWAP(COLOR_MAX,COLOR_SECOND) -> SEQ(SEQ(UPSCALE_2X -> RECOLOR(COLOR_UNIQUE,COLOR_MAX) -> CROP_NONZERO) -> SEQ(DELETE_COLS_ZERO -> DELETE_COLS_ZERO -> CROP_NONZERO) -> SEQ(DELETE_ROWS_ZERO -> CROP_NONZERO)))
AST: ('SEQ', ('SWAP', 'COLOR_MAX', 'COLOR_SECOND'), ('SEQ', ('SEQ', 'UPSCALE_2X', ('RECOLOR', 'COLOR_UNIQUE', 'COLOR_MAX'), 'CROP_NONZERO'), ('SEQ', 'DELETE_COLS_ZERO', 'DELETE_COLS_ZERO', 'CROP_NONZERO'), ('SEQ', 'DELETE_ROWS_ZERO', 'CROP_NONZERO')))
