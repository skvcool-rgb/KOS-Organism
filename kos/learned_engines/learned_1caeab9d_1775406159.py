"""
Auto-generated learned engine: learned_1caeab9d_1775406159
Task: 1caeab9d
Description: Evolved for 1caeab9d: ('IF_PROPERTY', 'RIGHTMOST', ('SEQ', ('FOR_EACH_NODE', ('ALIGN_H', 'BOTTOMMOST')), ('FOR_EACH_NODE', 'MOVE_RIGHT_3'), ('ALIGN_V', 'LEAST_FREQUENT_COLOR'), ('ALIGN_V', 'TOPMOST')), ('ALIGN_V', 'LARGEST_AREA'))
AST: ('IF_PROPERTY', 'RIGHTMOST', ('SEQ', ('FOR_EACH_NODE', ('ALIGN_H', 'BOTTOMMOST')), ('FOR_EACH_NODE', 'MOVE_RIGHT_3'), ('ALIGN_V', 'LEAST_FREQUENT_COLOR'), ('ALIGN_V', 'TOPMOST')), ('ALIGN_V', 'LARGEST_AREA'))
...
def apply_rule(grid, rule=None):
    ...
    state = grid.copy()
    pass  # Unknown AST node: ('IF_PROPERTY', 'RIGHTMOST', ('SEQ', ('FOR_EACH_NODE', ('ALIGN_H', 'BOTTOMMOST')), ('FOR_EACH_NODE', 'MOVE_RIGHT_3'), ('ALIGN_V', 'LEAST_FREQUENT_COLOR'), ('ALIGN_V', 'TOPMOST')), ('ALIGN_V', 'LARGEST_AREA'))
