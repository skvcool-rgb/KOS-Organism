"""
Auto-generated learned engine: learned_7468f01a_1775415268
Task: 7468f01a
Description: Evolved for 7468f01a: IF_COLOR(COLOR_MAX, SEQ(SEQ(('CROP_TO_COLOR', 'ORIG_COLOR_FG_2') -> CROP_NONZERO) -> FLIP_H), MASK(COLOR_BG))
AST: ('IF_COLOR', 'COLOR_MAX', ('SEQ', ('SEQ', ('CROP_TO_COLOR', 'ORIG_COLOR_FG_2'), 'CROP_NONZERO'), 'FLIP_H'), ('MASK', 'COLOR_BG'))
