"""
Auto-generated learned engine: learned_5117e062_1775405174
Task: 5117e062
Description: Evolved for 5117e062: SEQ(SWAP(COLOR_UNIQUE,COLOR_MAX) -> SEQ(RECOLOR(COLOR_MIN,ORIG_COLOR_FG_2) -> ('CROP_TO_COLOR', 'COLOR_UNIQUE') -> RECOLOR(COLOR_MIN,COLOR_MAX)) -> RECOLOR(COLOR_MIN,COLOR_MAX))
AST: ('SEQ', ('SWAP', 'COLOR_UNIQUE', 'COLOR_MAX'), ('SEQ', ('RECOLOR', 'COLOR_MIN', 'ORIG_COLOR_FG_2'), ('CROP_TO_COLOR', 'COLOR_UNIQUE'), ('RECOLOR', 'COLOR_MIN', 'COLOR_MAX')), ('RECOLOR', 'COLOR_MIN', 'COLOR_MAX'))
