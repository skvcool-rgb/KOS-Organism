"""
Auto-generated learned engine: learned_b94a9452_1775398871
Task: b94a9452
Description: Evolved for b94a9452: SEQ(CROP_NONZERO -> FOR_EACH(SWAP(COLOR_FG_1,COLOR_MIN)) -> CROP_NONZERO)
AST: ('SEQ', 'CROP_NONZERO', ('FOR_EACH_OBJECT', ('SWAP', 'COLOR_FG_1', 'COLOR_MIN')), 'CROP_NONZERO')
...
def apply_rule(grid, rule=None):
    ...
    def _sub_transform(state):
        ...
        _c1, _c2 = _resolve_color("COLOR_FG_1", _orig_grid), _resolve_color("COLOR_MIN", _orig_grid)
