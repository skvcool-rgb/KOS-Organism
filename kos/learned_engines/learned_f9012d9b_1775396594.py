"""
Auto-generated learned engine: learned_f9012d9b_1775396594
Task: f9012d9b
Description: Evolved for f9012d9b: SEQ(SEQ(EXTRACT_QUADRANT_BR -> OVERLAY(IF_COLOR(8, SEQ(DELETE_ROWS_ZERO -> SWAP(COLOR_MIN,COLOR_MAX) -> DELETE_COLS_ZERO), SEQ(RECOLOR(2,5) -> ROT180 -> SHIFT_UP)), FLIP_H)) -> SHIFT_RIGHT -> EXTRACT_QUADRANT_BR -> RECOLOR(0,5))
AST: ('SEQ', ('SEQ', 'EXTRACT_QUADRANT_BR', ('OVERLAY', ('IF_COLOR', 8, ('SEQ', 'DELETE_ROWS_ZERO', ('SWAP', 'COLOR_MIN', 'COLOR_MAX'), 'DELETE_COLS_ZERO'), ('SEQ', ('RECOLOR', 2, 5), 'ROT180', 'SHIFT_UP')), 'FLIP_H')), 'SHIFT_RIGHT', 'EXTRACT_QUADRANT_BR', ('RECOLOR', 0, 5))
