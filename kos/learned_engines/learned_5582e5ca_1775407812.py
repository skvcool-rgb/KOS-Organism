"""
Auto-generated learned engine: learned_5582e5ca_1775407812
Task: 5582e5ca
Description: Evolved for 5582e5ca: SEQ(MASK(COLOR_FG_2) -> FOR_EACH(FILL_BG(COLOR_MIN)) -> OVERLAY(RECOLOR(ORIG_COLOR_UNIQUE,COLOR_FG_1), RECOLOR(COLOR_FG_2,ORIG_COLOR_BG)))
AST: ('SEQ', ('MASK', 'COLOR_FG_2'), ('FOR_EACH_OBJECT', ('FILL_BG', 'COLOR_MIN')), ('OVERLAY', ('RECOLOR', 'ORIG_COLOR_UNIQUE', 'COLOR_FG_1'), ('RECOLOR', 'COLOR_FG_2', 'ORIG_COLOR_BG')))
...
def apply_rule(grid, rule=None):
    ...
    def _sub_transform(state):
        ...
        state[state == 0] = _resolve_color("COLOR_MIN", _orig_grid)
        return state
    ...
    result_a = state.copy()
    state = state_a.copy()
    state[state == _resolve_color("COLOR_FG_2", _orig_grid)] = _resolve_color("COLOR_BG", _orig_grid)
    result_b = state.copy()
    state = result_a.copy()
    mask = result_b != 0
