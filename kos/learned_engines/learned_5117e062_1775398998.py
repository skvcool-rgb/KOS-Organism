"""
Auto-generated learned engine: learned_5117e062_1775398998
Task: 5117e062
Description: Evolved for 5117e062: SEQ(SEQ(SWAP(COLOR_UNIQUE,COLOR_MAX) -> SEQ(RECOLOR(COLOR_MIN,ORIG_COLOR_FG_2) -> ('CROP_TO_COLOR', 'COLOR_UNIQUE') -> RECOLOR(COLOR_MIN,COLOR_MAX)) -> RECOLOR(COLOR_MIN,COLOR_MAX)) -> RECOLOR_ALL_TO_MAX)
AST: ('SEQ', ('SEQ', ('SWAP', 'COLOR_UNIQUE', 'COLOR_MAX'), ('SEQ', ('RECOLOR', 'COLOR_MIN', 'ORIG_COLOR_FG_2'), ('CROP_TO_COLOR', 'COLOR_UNIQUE'), ('RECOLOR', 'COLOR_MIN', 'COLOR_MAX')), ('RECOLOR', 'COLOR_MIN', 'COLOR_MAX')), 'RECOLOR_ALL_TO_MAX')
...
def apply_rule(grid, rule=None):
    ...
    state = grid.copy()
    _c1, _c2 = _resolve_color("COLOR_UNIQUE", _orig_grid), _resolve_color("COLOR_MAX", _orig_grid)
    ...
    state[state == _resolve_color("COLOR_MIN", _orig_grid)] = _resolve_color("COLOR_MAX", _orig_grid)
    state[state == _resolve_color("COLOR_MIN", _orig_grid)] = _resolve_color("COLOR_MAX", _orig_grid)
